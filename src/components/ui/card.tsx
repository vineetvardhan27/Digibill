  ...
  "rounded-xl border border-border/50",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-to-br from-card to-muted/50 shadow-lg",
        stat: "bg-card text-card-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1",
      },
    },
    defaultVariants: {
      variant: "default",
